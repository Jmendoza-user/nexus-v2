// ============================================================
// NEXUS — Tweaks panel (port de tweaks-panel.jsx)
// Adaptación: se elimina el protocolo host (postMessage a window.parent,
// __edit_mode_*) que solo aplica dentro de la herramienta de edición del
// diseñador. En el stack real `useTweaks` es estado local puro y el panel
// arranca abierto para conservar los controles de marca/tema/tipografía.
// Los controles (TweakColor, TweakRadio, TweakSlider, TweakToggle, etc.) y
// sus estilos se portan VERBATIM.
// ============================================================
...
// ── useTweaks ────────────────────────────────────────────────
// Estado local puro. (Original posteaba a un host de edición; aquí no aplica.)
function useTweaks(defaults: Any): [Any, (keyOrEdits: Any, val?: Any) => void] {
...
function TweaksPanel({ title = 'Tweaks', children }: { title?: string; children: ReactNode }) {
  // Arranca abierto: en el stack real no hay toolbar del host para activarlo.
